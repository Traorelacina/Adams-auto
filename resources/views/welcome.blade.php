...
@livewireScripts
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Le Royaume des véhicules en Côte d'Ivoire</p>
        ...
        <div class="container">
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <p>Découvrez notre large sélection de voitures neuves et d'occasion pour tous les budgets.</p>
                    <a href="#" class="btn btn-outline">Voir le catalogue</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <p>Louez une voiture pour vos déplacements professionnels ou personnels en toute simplicité.</p>
                    <a href="#" class="btn btn-outline">Voir les offres</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <p>Notre équipe de techniciens qualifiés prend soin de votre véhicule avec expertise.</p>
                    <a href="#" class="btn btn-outline">Nos prestations</a>
                </div>
            </div>
        </div>
    </section>

<!-- Popular Cars Section Structure -->
<section id="cars" class="popular-cars py-10">
    <div class="container mx-auto px-4">
        <!-- Section des voitures à vendre -->
        <div class="sale-section animated-fade mb-16">
            ...
            <div class="text-center mt-8">
                <a href="{{ route('cars.for-sale') }}" 
                   class="bg-green-600 hover:bg-green-700 text-white py-2 px-6 rounded-lg font-medium transition-colors duration-300" 
                   data-authenticated="{{ auth()->check() ? 'true' : 'false' }}"
                   onclick="return checkAuth(event, this)">
                    Voir toutes les voitures à vendre
                </a>
            </div>
        </div>
        
        <!-- Section des voitures à louer -->
        <div class="rent-section animated-fade">
            <div class="section-title text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-800">Voitures à Louer</h2>
                <p class="text-gray-600 mt-2">Explorez notre sélection de véhicules disponibles en location</p>
            </div>
            <div class="cars-grid">
                <livewire:cars-for-rent-home />
            </div>
            <div class="text-center mt-8">
                <a href="{{ route('cars.for-rent') }}" 
                   class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg font-medium transition-colors duration-300" 
                   data-authenticated="{{ auth()->check() ? 'true' : 'false' }}"
                   onclick="return checkAuth(event, this)">
                    Voir toutes les voitures à louer
                </a>
            </div>
        </div>
    </div>
