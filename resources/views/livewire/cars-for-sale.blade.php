<!-- Component: cars-for-sale.blade.php -->
<div class="py-8">
    <div class="container mx-auto px-4">
        <h2 class="text-2xl font-bold text-gray-800 mb-6 pb-3 border-b-2 border-gray-100 flex items-center">
            <span class="w-1 h-8 bg-green-700 rounded mr-3 shadow-md shadow-green-300"></span>
        ...
        <div class="bg-white rounded-lg shadow-md p-5 mb-6 transform transition-all hover:shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label for="marque-vente" class="block text-sm font-medium text-gray-600 mb-1">Marque</label>
                    <select id="marque-vente" class="w-full border border-gray-200 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all">
                ...
                @foreach($cars as $car)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-xl hover:transform hover:scale-[1.02]">
                        ...
                        <div class="relative group">
                            ...
                            @endif
                            <span class="absolute top-4 right-4 bg-green-600 text-white text-sm font-bold px-3 py-1 rounded-full shadow-lg transform transition-all duration-300 group-hover:scale-110">
                                À vendre
                            </span>
                        </div>
