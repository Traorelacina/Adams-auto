    ...
    <div class="container mx-auto px-4">
                ...
                @foreach($cars->take(5) as $car)
                    <div class="car-card">
                        <div class="car-card__image relative">
                            ...
                            @endif
                            <span class="car-card__badge car-card__badge--rent">
                                Location
                            </span>
                        </div>
                        ...
                        <div class="car-card__content">
                            ...
                            <div class="car-card__price car-card__price--rent">
                            ...
                            <div class="car-card__details">
                                ...
                                <a href="{{ route('cars.show', $car->id) }}" 
                                   class="car-card__btn car-card__btn--rent">
                                    Détails
                                </a>
                            </div>
                        </div>
        ...
        @else
            <div class="no-cars-message">
                <h3>Aucune voiture en location disponible</h3>
            </div>
        @endif
    </div>
</div>