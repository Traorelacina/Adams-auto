<!-- resources/views/livewire/cars-for-sale-home.blade.php -->
<div class="py-4">
    <div class="container mx-auto px-4">
                ...
                @foreach($cars->take(5) as $car)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="relative">
                            ...
                            @endif
                            <span class="absolute top-3 right-3 bg-green-600 text-white text-xs font-semibold px-2 py-1 rounded-full">
                                À vendre
                            </span>
                        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between mb-2">
                                ...
                                <a href="{{ route('cars.show', $car->id) }}" class="bg-green-600 hover:bg-green-700 text-white text-xs font-medium py-1 px-3 rounded-lg transition-colors duration-300">
                                    Détails
                                </a>
                            </div>
                        </div>
        ...
        @else
            <div class="bg-white rounded-lg shadow-md p-4 text-center">
                <h3 class="text-lg font-medium text-gray-900">Aucune voiture à vendre disponible</h3>
            </div>
        @endif
    </div>
</div>